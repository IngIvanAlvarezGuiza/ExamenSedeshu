	      	...
	      	<div class="card">
	          	<div class="card-block">
	                ...
	                <div class="form-titulo">
	                  Editar usuario <i class="fa fa-male" aria-hidden="true"></i>
	                  	...
	                  	<div class="row">
	                          <div class="form-group col-md-4" style="margin: auto;">
	                              <label for="txtClave">Clave:</label>
	                          	  <input type="text" disabled style="text-transform: uppercase;" maxlength="50" class="form-control" id="txtClave" value="{{ $usuario->usu_cve }}">
	                          </div>
	                     </div><br>
	                     <div class="row">
	                         <div class="form-group col-md-9" style="margin: auto;">
	                              <label for="txtNombre">*Nombre:</label>
	                          	<input type="text"class="form-control" id="txtNombre"  value="{{ $usuario->usu_nombre }}">
	                         </div>
	                     </div><br>
	                     <div class="row">
	                         <div class="form-group col-md-9" style="margin: auto;">
	                              <label for="txtUsuario">*Usuario:</label>
	                          	<input type="text" class="form-control" id="txtUsuario"  value="{{ $usuario->usu_usuario }}">
	                         </div>
	                     </div><br>
	                     <div class="row">
	                         <div class="form-group col-md-9" style="margin: auto;">
	                              <label for="txtContrasenia">*Contraseña:</label>
	                          	<input type="text" class="form-control" id="txtContrasenia"  value="{{ $usuario->usu_contrasenia }}">
	                         </div>
	                     </div><br>
	                     <div class="row">
	                         <div class="form-group col-md-9" style="margin: auto;">
	                              <label for="txtContrasenia">*Repetir contraseña:</label>
	                          	<input type="text"  class="form-control" id="txtRepiteContrasenia"  value="{{ $usuario->usu_contrasenia }}">
	                         </div>
	                     </div><br>
